...
public class AugmentScrollData implements IXmlReader
{
	private final Map<Integer, L2AugmentScroll> _scrolls = new HashMap<>();
	
	public AugmentScrollData()
	{
		load();
	}
	...
	public void load()
	{
		...
		LOG.info("Loaded {} augment scrolls.", _scrolls.size());
	}
	...
	public static AugmentScrollData getInstance()
	{
	...
	{
		protected static final AugmentScrollData INSTANCE = new AugmentScrollData();
	}
}