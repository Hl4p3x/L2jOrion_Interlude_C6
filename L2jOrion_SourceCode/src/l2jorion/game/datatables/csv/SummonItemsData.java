...
{
	private static Logger LOG = LoggerFactory.getLogger(SummonItemsData.class);
	...
	public SummonItemsData()
	{
		...
		try
		{
			...
			while (s.hasNextLine())
			{
				...
				catch (final Exception e)
				{
					...
					LOG.info("Summon items data: Error in line " + lineCount + " -> incomplete/invalid data or wrong seperator!");
					LOG.info("		" + line);
					ok = false;
				}
		...
		catch (final Exception e)
		{
			...
			LOG.info("Summon items data: Can not find './data/summon_items.csv'");
		}
		finally
		{
