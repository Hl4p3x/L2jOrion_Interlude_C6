	...
	public void useItem(L2PlayableInstance playable, L2ItemInstance item)
	{
		if(Config.PREMIUM_CUSTOM_ITEMS)
		{
			...
			else
			{
				...
				activeChar.sendMessage("Congratulations! You are The Premium account now.");
				activeChar.sendPacket(new ExShowScreenMessage("Congratulations! Now you have The Premium Account.", 4000, 0x02, false));
