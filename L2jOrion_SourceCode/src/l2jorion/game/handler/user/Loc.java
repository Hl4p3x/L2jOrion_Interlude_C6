	...
	public boolean useUserCommand(int id, L2PcInstance activeChar)
	{
		...
		switch(_nearestTown)
		{
			...
			case 18:
				...
				break;
			case 19:
				msg = SystemMessageId.LOC_PVP_ZONE_S1_S2_S3;
			default:
				msg = SystemMessageId.LOC_ADEN_S1_S2_S3;
		}
		...
		if (activeChar.isGM())
		{
			SystemMessage sm2 = new SystemMessage(msg);
			sm2.addNumber(activeChar.getClientX());
			sm2.addNumber(activeChar.getClientY());
			sm2.addNumber(activeChar.getClientZ());
