...
public class L2TopGr extends VoteBase
{
	@Override
	...
	{
		return String.format("https://l2top.gr/index.php?a=in&u=%s&ipc=%s", Config.VOTE_L2TOPGR_NAME, getPlayerIp(player));
	}
	
	@Override
	public void setVoted(L2PcInstance player)
	{
		player.setLastL2TopGr(System.currentTimeMillis());
	}
}