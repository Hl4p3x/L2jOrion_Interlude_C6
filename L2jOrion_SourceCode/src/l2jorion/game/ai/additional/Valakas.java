...
public class Valakas extends Quest implements Runnable
{
	...
	public Valakas(int id,String name,String descr)
	{
		...
		else if(status == FIGHTING)
		{
				...
				{
					Announcements.getInstance().announceRB("The Grand boss " + valakas.getName() + " spawned in world.");
				}
				String text = "Valakas spawned.";
	...
	public String onKill(L2NpcInstance npc, L2PcInstance killer, boolean isPet)
	{
		...
		if(!npc.getSpawn().is_customBossInstance())
		{
			...
			time.set(Calendar.HOUR, Config.VALAKAS_FIX_TIME_H);
	...
	public void getRandomSkill(L2NpcInstance npc)
	{
		...
		//System.out.println("Skill name: " + skill.getName() + " ID:" + skill.getId() + " Level:" + skill.getLevel() + " Power:" + skill.getPower(player));
	}
