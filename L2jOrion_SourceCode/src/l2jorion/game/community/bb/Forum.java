...
public class Forum
{
	private static Logger LOG = LoggerFactory.getLogger(Forum.class);
	...
	private void load()
	{
		...
		{
			LOG.error("Couldn't load forums with id {}.", e, _forumId);
		}
		finally
		{
			CloseUtil.close(con);
	...
	private void getChildren()
	{
		...
		{
			LOG.error("Couldn't load children forum for parentId {}.", e, _forumId);
		}
		finally
		{
			CloseUtil.close(con);
