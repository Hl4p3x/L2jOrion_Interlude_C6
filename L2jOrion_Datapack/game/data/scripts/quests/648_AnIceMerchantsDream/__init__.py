...
class Quest (JQuest) :
 ...
 def onTalk (self,npc,player):
    ...
    htmltext = "<html><body>You are either not on a quest that involves this NPC, or you don't meet this NPC's minimum quest requirements.<br> <font color=LEVEL>Characters must have achieved at least level 53 to undertake this quest, maximum level for this quest is 63!</font></body></html>" 
    ...
    silver = st.getQuestItemsCount(Silver_Ice)
    black = st.getQuestItemsCount(Black_Ice)
    if npcId == Rafforty and player.getLevel() < 64:
       if id == CREATED :
