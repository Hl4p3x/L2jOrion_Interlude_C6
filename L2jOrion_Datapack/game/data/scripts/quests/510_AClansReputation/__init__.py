...
from l2jorion.game.network.serverpackets import PledgeShowInfoUpdate
from l2jorion.game.network.serverpackets import SystemMessage
...
class Quest (JQuest) :
 ...
 def onKill(self,npc,player,isPet) :
  ...
  if st.getState() == STARTED :
   npcId=npc.getNpcId()
   if npcId in [22215, 22216, 22217, 22318, 22319] :
      st.giveItems(Claw,1)
...
for npc in [22215, 22216, 22217, 22318, 22319]:
    QUEST.addKillId(npc)